...
//        instructionToByte(new Instruction(Operation.call,symbolTableList.get(0).get("main").number));
    ...
    private void analyseFunc() throws CompileError {
        ...
        if (token.getValueString().equals("calcPi")) {
            Analyser.o = 1;
            String a="72303b3e00000001000000030000000008000000000000000000000000092d332e3134313539310000000008322e3731383238320000000200000000000000000000000000000000000000014800000001000000000000000000000000000000000000000601 000000000000000157580100000000000000025749";
            hexToByte(a);
        }
